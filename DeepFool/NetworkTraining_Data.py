...
'''
file = open('/home/shayan/Adv_Dataset/TrainingIndices.txt', 'w')
file.write(str(idx_train))
file.close()
file = open('/home/shayan/Adv_Dataset/TestingIndices.txt', 'w')
file.write(str(idx_test))
file.close()
'''
...
for i in range(7284,7285):

    xorg_ini, y0_ini = X_train[i], y_train[i]

    xorg = np.expand_dims(xorg_ini, axis=0)
    y0 = np.expand_dims(y0_ini, axis=0)

    xadvs_0 = make_fgsm(sess, env, xorg, eps=0.1, epochs=1)
    xadvs_1 = make_jsma(sess, env, xorg, eps=20, epochs=1)
    xadvs_2 = make_deepfool(sess, env, xorg, eps=20, epochs=1)
    ...
    if fgsm_acc <= 0.20:
        fig = plt.figure()
        plt.imshow(xadvs_0)
        plt.imsave('/home/shayan/Adv_Dataset/Train/FGSM/Fooling_Data/xadvs_' + str(i) + '_fgsm_' + '_' + str(fgsm_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_0)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/FGSM/Fooling_Clean_Data/xadvs_' + str(i) + '_fgsm_' + '_' + str(fgsm_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    else:
        fig = plt.figure()
        plt.imshow(xadvs_0)
        plt.imsave('/home/shayan/Adv_Dataset/Train/FGSM/Unfooling_Data/xadvs_' + str(i) + '_fgsm_' + '_' + str(fgsm_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_0)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/FGSM/Unfooling_Clean_Data/xadvs_' + str(i) + '_fgsm_' + '_' + str(fgsm_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    ...
    if jsma_acc <= 0.20:
        fig = plt.figure()
        plt.imshow(xadvs_1)
        plt.imsave('/home/shayan/Adv_Dataset/Train/JSMA/Fooling_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_1)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/JSMA/Fooling_Clean_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    else:
        fig = plt.figure()
        plt.imshow(xadvs_1)
        plt.imsave('/home/shayan/Adv_Dataset/Train/JSMA/Unfooling_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_1)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/JSMA/Unfooling_Clean_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    ...
    if deep_acc <= 0.20:
        fig = plt.figure()
        plt.imshow(xadvs_2)
        plt.imsave('/home/shayan/Adv_Dataset/Train/DeepFool/Fooling_Data/xadvs_' + str(i) + '_deepfool_' + '_' + str(deep_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_2)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/DeepFool/Fooling_Clean_Data/xadvs_' + str(i) + '_deepfool_' + '_' + str(deep_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    else:
        fig = plt.figure()
        plt.imshow(xadvs_2)
        plt.imsave('/home/shayan/Adv_Dataset/Train/DeepFool/Unfooling_Data/xadvs_' + str(i) + '_deepfool_' + '_' + str(deep_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_2)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/DeepFool/Unfooling_Clean_Data/xadvs_' + str(i) + '_deepfool_' + '_' + str(deep_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    ...
    if cw_acc <= 0.20:
        fig = plt.figure()
        plt.imshow(xadvs_3)
        plt.imsave('/home/shayan/Adv_Dataset/Train/CW/Fooling_Data/xadvs_' + str(i) + '_cw_' + '_' + str(cw_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_3)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/CW//Fooling_Clean_Data/xadvs_' + str(i) + '_cw_' + '_' + str(cw_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    else:
        fig = plt.figure()
        plt.imshow(xadvs_3)
        plt.imsave('/home/shayan/Adv_Dataset/Train/CW/Unfooling_Data/xadvs_' + str(i) + '_cw_' + '_' + str(cw_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_3)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Adv_Dataset/Train/CW/Unfooling_Clean_Data/xadvs_' + str(i) + '_cw_' + '_' + str(cw_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
