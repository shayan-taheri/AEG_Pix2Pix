...
parser.add_argument("--save_freq_epoch", type=int, default=31686, help="save model at every epoch (steps number), 0 to disable")
...
ModelX = collections.namedtuple("Model", "outputs, gan_total, l1_total, classes, adver_total, adv_real, adv_fake, predict_real, predict_fake, discrim_loss, discrim_grads_and_vars, gen_loss_GAN, gen_loss_L1, gen_loss, gen_grads_and_vars, train")
...
def main():
    ...
    if a.mode == "export":
        ...
        with tf.Session() as sess:
            ...
            restore_saver.restore(sess, '/home/shayan/CIFAR/tensorflow-adversarial-master/example/deepfool_model/pix2pix_adv/iter4/{}'.format(name))
        ...
        if a.mode == "test":
            ...
            for step in range(max_steps):
                ...
                if should(a.save_freq_epoch):
                    ...
                    if not os.path.exists("/home/shayan/Proposal_Pix2Pix/Data/Training/DeepFool/Iteration_5/Training_Out/Model_Epochs/" + "Epoch_" + str(epoch_count)):
                        os.mkdir("/home/shayan/Proposal_Pix2Pix/Data/Training/DeepFool/Iteration_5/Training_Out/Model_Epochs/" + "Epoch_" + str(epoch_count))

                    from distutils.dir_util import copy_tree
                    copy_tree(a.output_dir, "/home/shayan/Proposal_Pix2Pix/Data/Training/DeepFool/Iteration_5/Training_Out/Model_Epochs/" + "Epoch_" + str(epoch_count))
