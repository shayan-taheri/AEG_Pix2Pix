...
parser.add_argument("--save_freq_epoch", type=int, default=49874, help="save model at every epoch (steps number), 0 to disable")
...
def main():
    ...
    if a.mode == "export":
        ...
        with tf.Session() as sess:
            ...
            restore_saver.restore(sess, '/home/shayan/CIFAR/tensorflow-adversarial-master/example/model/{}'.format(name))
        ...
        if a.mode == "test":
            ...
            for step in range(max_steps):
                ...
                if should(a.save_freq_epoch):
                    ...
                    if not os.path.exists("/home/shayan/Proposal_Pix2Pix/Data/Training/FGSM/Training_Out/Model_Epochs/" + "Epoch_" + str(epoch_count)):
                        os.mkdir("/home/shayan/Proposal_Pix2Pix/Data/Training/FGSM/Training_Out/Model_Epochs/" + "Epoch_" + str(epoch_count))

                    from distutils.dir_util import copy_tree
                    copy_tree(a.output_dir, "/home/shayan/Proposal_Pix2Pix/Data/Training/FGSM/Training_Out/Model_Epochs/" + "Epoch_" + str(epoch_count))
