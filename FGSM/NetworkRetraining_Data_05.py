...
len_list = []
for img in glob.glob('/home/shayan/Proposal_Pix2Pix/Data/Testing/Testing_Out/Epoch_5/outputs/' + '*.png'):
...
for i in range(0,len(X_test)):
    ...
    if jsma_acc <= 0.20:
        fig = plt.figure()
        plt.imshow(xadvs_2)
        plt.imsave('/home/shayan/Proposal_Pix2Pix/Data/Retraining_Results/Epoch_5/Fooling_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_2)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Proposal_Pix2Pix/Data/Retraining_Results/Epoch_5/Fooling_Clean_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)
    else:
        fig = plt.figure()
        plt.imshow(xadvs_2)
        plt.imsave('/home/shayan/Proposal_Pix2Pix/Data/Retraining_Results/Epoch_5/Unfooling_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xadvs_2)
        plt.close(fig)
        fig = plt.figure()
        plt.imshow(xorg)
        plt.imsave('/home/shayan/Proposal_Pix2Pix/Data/Retraining_Results/Epoch_5/Unfooling_Clean_Data/xadvs_' + str(i) + '_jsma_' + '_' + str(jsma_acc) + '_[' + str((int(y0[0])*0+int(y0[1])*1)) + '].png',xorg)
        plt.close(fig)